Feature: Validating MFORCE Customer services

  Background: Create MFORCE Customer
    Given We have an ENDPOINT_baseURI "BaseUrl"
    And We declare a new Request
    And We have below Form parameters
      | fname           | MFORCE_Automation           |
      | lname           | MFORCE_Testing              |
      | origin          | APP                         |
      | email           | <RandomEmail>               |
      | magcode         | SI                          |
  ...
  @CustomerCreation
  Scenario: Update MFORCE Customer
    Given We declare a new Request
    And We have below Path parameters
      | userid  | <FetchFromRequestParameters> |
      | magcode | <FetchFromRequestParameters> |
  ...
  Scenario: Delete MFORCE Customer
    Given We declare a new Request
    And We have below Path parameters
      | userid  | <FetchFromRequestParameters> |
      | magcode | <FetchFromRequestParameters> |
  ...
  @CustomerCreation
  Scenario: Change MFORCE Password
    Given We declare a new Request
    And We have below Path parameters
      | userid  | <FetchFromRequestParameters> |
      | magcode | <FetchFromRequestParameters> |
  ...
  @CustomerCreation
  Scenario: Reset MFORCE Password
    Given We declare a new Request
    And We have below Path parameters
      | userid  | <FetchFromRequestParameters> |
      | magcode | <FetchFromRequestParameters> |
  ...
  @CustomerCreation
  Scenario: MFORCE Get AuthToken With Entitlements
    Given We declare a new Request
    And We have below Path parameters
      | userid  | <FetchFromRequestParameters> |
      | magcode | <FetchFromRequestParameters> |
  ...
  @CustomerCreation
  Scenario: MFORCE Get AuthToken With CustomerData
    Given We declare a new Request
    And We have below Path parameters
      | userid  | <FetchFromRequestParameters> |
      | magcode | <FetchFromRequestParameters> |
  ...
  @CustomerCreation
  Scenario: MFORCE Get AuthToken With Entitlement and CustomerData
    Given We declare a new Request
    And We have below Path parameters
      | userid  | <FetchFromRequestParameters> |
      | magcode | <FetchFromRequestParameters> |
  ...
  @CustomerCreation
  Scenario: MFORCE RenewAuthToken
    Given We declare a new Request
  ...
  @CustomerCreation
  Scenario: MFORCE Get Entitlements
    Given We declare a new Request
    And We have the below Query parameters
      | CGI-App-Id | <FetchFromRequestParameters> |
    And We have below Header parameters
